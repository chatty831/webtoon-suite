...
from src.utils import colorize_images, upscale_images, convert_images_to_base64, preprocess_images
...
async def process_images(images_request: ImagesRequest, translate: bool, colorize: bool, upscale: bool):
    ...
    try:
        ...
        final_results = update_cache_and_results(
            base64_results, process_indices, cache_keys, final_results
        )
